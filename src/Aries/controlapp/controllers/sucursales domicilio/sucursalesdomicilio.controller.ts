...
export class SucursalesDomicilioController {
  ...
  @Get('obtener/:id')
  @ApiOperation({
    summary: 'OrionWS - AriesERP - Modulo App - Sucursales Domiclio - Obtener.',
  })
  @ApiResponse({
    status: 200,
    description:
      'OrionWS - AriesERP - Modulo App - Sucursales Domiclio - Obtener.',
    content: {
      'application/json': {
        example: {
          Success: true,
  ...
  @ApiResponse({
    status: 200,
    description:
      'OrionWS - AriesERP - Modulo App - Sucursales Domiclio - Agregar',
    content: {
      'application/json': {
        example: {
          Success: true,
          Titulo:
            'OrionWS - AriesERP - Modulo App - Sucursales Domicilio - Agregar',
  ...
  @ApiResponse({
    status: 200,
    description:
      'AriesERP - Modulo Compras - Sucursales Domicilio - Actualizar.',
    content: {
      'application/json': {
        example: {
          Success: true,
